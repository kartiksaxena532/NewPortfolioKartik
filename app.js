...
const saluteImgContainer = document.querySelector(".saluteImage")
const devImgContainer = document.querySelector(".imagedev")
...
window.addEventListener("scroll", ()=>{
  ...
  saluteImgContainer.style.transform= `translateY(${offsetY * 0.2}px)`
  devImgContainer.style.transform= `translateY(${offsetY * 0.11}px)`
